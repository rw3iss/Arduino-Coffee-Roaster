#line 1 "/Users/rw3iss/Documents/Arduino/Projects/Roaster/src/lib/app/Stack.h"
#pragma once

// Taken from https://github.com/shah253kt/Stack.
...
class Stack {
   ...
   public:
     ...
     */
    Stack(uint16_t size) : mCurrentSize(0), mMaxSize(size) {
        mStack = new T[size];
    }
     ...
     * @return true if stack is not yet full and successfully added the object
     * onto the stack.
    ...
    /**
     * @brief Get the object at the top of the stack without removing it from the
     * stack.
     *
     ...
     */
    uint16_t getSize() { return mCurrentSize; }
     ...
     */
    uint16_t getMaxSize() { return mMaxSize; }
     ...
     */
    bool isEmpty() { return mCurrentSize == 0; }
     ...
     */
    bool isFull() { return mCurrentSize >= mMaxSize; }

    /**
     * @brief Empty the stack.
     *
     */
    void empty() { mCurrentSize = 0; }
};